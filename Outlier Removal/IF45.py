...
results_folder = "IsolationForest_Results_3_45" # Changed output directory name
os.makedirs(results_folder, exist_ok=True)

las_file = laspy.read("/data/landfills_UAV/3dData/FinalMesh/Asbestos45.las") # Changed LAS file to Asbestos2.las
