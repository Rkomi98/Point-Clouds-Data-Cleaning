...
# --- Output Directories ---
output_dir_sor = "SOR_Results_45_Small"
...
def indices_confusion_matrix(y_true, y_pred, method_name, execution_time, original_tags, output_dir, threshold=None, sor_params=None): # MODIFICATION: Added sor_params for SOR info
    ...
    metrics_filename = os.path.join(output_dir, f"{method_name}{threshold_str}{sor_param_str}_metrics_noise_45.txt") # MODIFICATION: Added sor_param_str to filename
    ...
    plot_filename = os.path.join(output_dir, f"{method_name}{threshold_str}{sor_param_str}_confusion_matrix_noise_45.png") # MODIFICATION: Added sor_param_str to filename
...
nb_neighbors_list = [110,120,130]
#nb_neighbors_list = [50, 100, 150]
#std_ratio_list = [0.1, 1.0, 3.0, 5.0, 6.5, 8.0, 50.0]
std_ratio_list = [6.5, 7, 7.5, 8.0, 8.5,9]
