...
def filter_and_evaluate(df_noisy, pcd_filtered, displacement_threshold=0.1, log_file_path="Real/evaluation_log.txt"):
...
if __name__ == "__main__":
    ...
    try:
        ...
        df_filtered = filter_and_evaluate(df_noisy, pcd_filtered, displacement_threshold=0.1)
